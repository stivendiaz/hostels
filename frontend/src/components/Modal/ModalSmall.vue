...
<template>
  <div v-show="isOpen">
    <div class="fixed inset-0 z-100 z-100" @click="$emit('closeModal')"></div>
    <div class="inset-0 z-100 flex justify-center items-center">
      <div
      ...
      >
        <div class="flex justify-between items-center mb-4">
          ...
          <button class="hover:text-gray-700" @click="$emit('closeModal')">
